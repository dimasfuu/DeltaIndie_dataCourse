...
FCVC = st.number_input("Konsumsi buah-buahan", min_value=0, max_value=3, step=1)  
...
FAF = st.number_input("Frekuensi Aktivitas fisik", min_value=0.0, step=0.1)  
...
En_MTRANS = st.number_input("Pola Transportasi", min_value=0, max_value=4, step=1)  
